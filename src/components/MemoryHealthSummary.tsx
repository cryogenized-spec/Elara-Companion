  ...
  return (
    <section className="rounded-2xl border border-zinc-800 bg-zinc-900/55 p-3 sm:p-4">
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="rounded-md border border-zinc-700 bg-zinc-950 px-2 py-1 text-[9px] text-zinc-500">schema v{summary.schemaVersion}</span>
      </div>
      ...
      <div className="mt-3 flex items-center gap-2 text-[9px] text-zinc-600"><RefreshCw className="h-3 w-3" /> Last maintenance: {maintenanceLabel}</div>
    </section>
  );
};
