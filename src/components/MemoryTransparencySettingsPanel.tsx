...
export const MEMORY_RESOLUTION_FILTERS: MemoryResolutionFilter[] = [
  'all', 'core', 'contextual', 'episodic', 'observation', 'synthesized',
];
...
export const countMemoryResolutions = (memories: MemoryItem[]): Record<MemoryResolutionFilter, number> => {
  const counts: Record<MemoryResolutionFilter, number> = {
    all: memories.length,
    core: 0,
    contextual: 0,
    episodic: 0,
