...
const memory = (overrides: Partial<MemoryItem> = {}): MemoryItem => ({
  id: 'mem-1', content: 'Workshop plan.', kind: 'project', lifecycle: 'persistent', resolution: 'contextual', state: 'active',
  source: 'conversation', confidence: 'likely', importance: 'normal', isPrivate: true, category: 'Projects',
  createdAt: '2026-08-01T00:00:00.000Z', updatedAt: '2026-08-20T00:00:00.000Z', reinforcementCount: 2, evidenceCount: 3,
  evidenceMemoryIds: ['e-1', 'e-2', 'e-3'], pinned: false, ...overrides,
});

const state = (...memories: MemoryItem[]): MemoryScratchpadState => ({
  memories, autoMaintenanceEnabled: true, lastMaintenanceAt: '2026-08-21T08:00:00.000Z', schemaVersion: 3,
});
