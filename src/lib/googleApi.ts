// Google Workspace compatibility façade.
...
// Compatibility names retained for older consumers while ownership is centralized.
...
// Legacy compatibility exports. The V3 agent path uses workspaceTools.ts + googleAgentTools.ts.
