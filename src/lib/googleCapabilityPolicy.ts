export type GoogleCapability =
  ...
  | 'calendar.read' | 'calendar.write' | 'tasks' | 'docs' | 'drive.read' | 'drive.file'
...
const CAPABILITY_SCOPES: Record<GoogleCapability, readonly string[]> = {
  ...
  'calendar.read': ['https://www.googleapis.com/auth/calendar.readonly'], 'calendar.write': ['https://www.googleapis.com/auth/calendar.events'], tasks: ['https://www.googleapis.com/auth/tasks'], docs: ['https://www.googleapis.com/auth/documents'], 'drive.read': ['https://www.googleapis.com/auth/drive.readonly'], 'drive.file': ['https://www.googleapis.com/auth/drive.file'],
