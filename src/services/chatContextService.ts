...
import { getLoadedMemoryState } from './memoryService';
...
} from '../lib/contextProjectionStorage';
...
export interface SystemPayloadOptions {
...
/** Canonical application-owned system payload assembly for Chat and specialised conversational surfaces. */
